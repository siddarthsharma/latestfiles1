    ...
    <div class="auto-style1">
        ...
        <h1><strong><span class="auto-style7">COURSE</span></strong></h1>
                ...
                <div class="auto-style4">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <div class="auto-style3">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="COURSE_ID" DataSourceID="AccessDataSource1" EmptyDataText="There are no data records to display." Height="337px" Width="637px" CssClass="auto-style10">
                            <Columns>
